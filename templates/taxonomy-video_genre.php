<?php
/**
 * Taxonomy template for video_genre.
 *
...
<main class="cvl-page cvl-taxonomy-page">
	<section class="cvl-hero">
		<div class="cvl-shell">
			<p class="cvl-kicker"><?php esc_html_e( 'Genre', 'custom-video-library' ); ?></p>
	...
	<section class="cvl-shell cvl-content-section">
		...
		<?php else : ?>
			<p><?php esc_html_e( 'No videos in this genre.', 'custom-video-library' ); ?></p>
		<?php endif; ?>
	</section>
</main>
<?php
